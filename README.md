...
- **What I learned:** I learned how HTTPS can be enabled through different layers—either directly via Nginx, or using AWS-managed certificates via ACM and an ALB. This experience deepened my understanding of cloud infrastructure, load balancing, and secure production deployment best practices.
</br></br>
